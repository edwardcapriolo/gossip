...
import io.teknek.gossip.lock.LockManagerSettings;
...
public class GossipSettings {
  ...
  private String activeGossipClass = "io.teknek.gossip.manager.SimpleActiveGossiper";

  private String transportManagerClass = "io.teknek.gossip.transport.udp.UdpTransportManager";
  private String protocolManagerClass = "io.teknek.gossip.protocol.json.JacksonProtocolManager";
